...
@section('title','Edit Business Report Management')
@section('content')
            ...
            <div class="col-12">
                <div class="page_title_box d-flex flex-wrap align-items-center justify-content-between">
                    <div class="page_title_left">
                        <h3 class="f_s_25 f_w_700 dark_text">Edit Business Report Management</h3>
                        <ol class="breadcrumb page_bradcam mb-0">
                            <li class="breadcrumb-item"><a href="javascript:void(0);">Edit Business Report Management</a></li>
                            <li class="breadcrumb-item"><a href="">Edit Business Report Management</a></li>
                        </ol>
                    </div>
