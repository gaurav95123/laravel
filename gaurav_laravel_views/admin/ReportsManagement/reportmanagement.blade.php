                ...
                <div class="page_title_box d-flex flex-wrap align-items-center justify-content-between">
                    ...
                    <div class="page_title_right">
                        <div class="add_button ms-2">
                            <a href="{{url('/add_reportmanagement')}}" class="btn_1">Add Reports Management</a>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                        <div class="action_btns d-flex justify-content-center">
                                                            <a href="{{url('/view_reportmanagement/'.base64_encode($list['id']))}}" class="action_btn mr_10"> <i class="far fa-eye"></i> </a>
                                                            <a href="{{url('//'.base64_encode($list['id']))}}" class="action_btn mr_10"> <i class="far fa-edit"></i> </a>
                                                            <a href="{{url('/delete_reportmanagement/'.base64_encode($list['id']))}}" class="action_btn"> <i class="fas fa-trash"></i> </a>
                                                        </div>
                                                </td>
                                            </tr>
                                            @endforeach
