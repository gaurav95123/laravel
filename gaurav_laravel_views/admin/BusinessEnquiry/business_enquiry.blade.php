            ...
            <div class="col-12">
                <div class="page_title_box d-flex flex-wrap align-items-center justify-content-between">
                    <div class="page_title_left">
                        <h3 class="f_s_25 f_w_700 dark_text">Business Enquiry</h3>
                        <ol class="breadcrumb page_bradcam mb-0">
                            <li class="breadcrumb-item"><a href="javascript:void(0);">Home</a></li>
                            <li class="breadcrumb-item active">Business Enquiry</li>
                        </ol>
                    </div>
                    <div class="page_title_right">
                        <div class="add_button ms-2">
                            <a href="{{url('/adddbusiness')}}" class="btn_1">Add Business Enquiry</a>
...
<a href="{{url('/business/exportexcel')}}" class="btn_1">Downloadexcel</a>
                                    ...
                                    <div class="serach_field_2">
                                        <div class="search_inner">
                                            <form action="{{url('/search-businessenquiry')}}" method="post">
                                                @csrf
                                        ...
                                        @foreach($busines as $list)
                                            <tr>
                                                ...
                                                <div class="action_btns d-flex justify-content-center">
                                                    <a href="{{url('/view_businessenquiry/'.base64_encode($list['id']))}}" class="action_btn mr_10"> <i class="far fa-eye"></i> </a>
                                                    <a href="{{url('/edit_businessenquiry/'.base64_encode($list['id']))}}" class="action_btn mr_10"> <i class="far fa-edit"></i> </a>
                                                    <a href="{{url('/delete_businessenquiry/'.base64_encode($list['id']))}}" class="action_btn"> <i class="fas fa-trash"></i> </a>
