            ...
            <div class="col-12">
                <div class="page_title_box d-flex flex-wrap align-items-center justify-content-between">
                    <div class="page_title_left">
                        <h3 class="f_s_25 f_w_700 dark_text">Report Reason</h3>
                        <ol class="breadcrumb page_bradcam mb-0">
                            <li class="breadcrumb-item"><a href="javascript:void(0);">Home</a></li>
                            <li class="breadcrumb-item active">Report Reason</li>
                        </ol>
                    </div>
                    <div class="page_title_right">
                        <div class="add_button ms-2">
                            <a href="{{url('/add_reportreason')}}" class="btn_1">Add Report Reason</a>
                            ...
                            <div class="table-responsive">
                                <div class="QA_table mb_30">
                                    ...
                                    <?php $count=1;?>
                                        ...
                                        <tbody>
                                        @foreach($businessreason as $list)
                                            ...
                                            <tr>
                                                ...
                                                <div class="action_btns d-flex justify-content-center">
                                                    <a href="{{url('/view_reportreason/'.base64_encode($list['id']))}}" class="action_btn mr_10"> <i class="far fa-eye"></i> </a>
                                                    <a href="{{url('/edit_reportreason/'.base64_encode($list['id']))}}" class="action_btn mr_10"> <i class="far fa-edit"></i> </a>
                                                    <a href="{{url('/delete_reportreason/'.base64_encode($list['id']))}}" class="action_btn del_item"> <i class="fas fa-trash"></i> </a>
