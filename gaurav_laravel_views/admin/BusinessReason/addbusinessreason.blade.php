...
@section('title','Add Report Reason')
@section('content')
            ...
            <div class="col-12">
                <div class="page_title_box d-flex flex-wrap align-items-center justify-content-between">
                    <div class="page_title_left">
                        <h3 class="f_s_25 f_w_700 dark_text">Add Report Reason</h3>
                        <ol class="breadcrumb page_bradcam mb-0">
                            <li class="breadcrumb-item"><a href="javascript:void(0);">Home</a></li>
                            <li class="breadcrumb-item "><a href="{{url('/business/manage')}}">Report Reason </a></li>
                            <li class="breadcrumb-item active">Add Report Reason </li>
                        </ol>
                    </div>
                                                    ...
                                                    <div class="tile" id="tile-1">
                                                        <div class="tab-content" id="myTabContent">
                                                            <div class="tab-pane fade show active" id="home"
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-xl-6">
                                                                        <form action="{{url('/add_reportreason')}}" method="post" id="basic-form">
                                                                            @csrf
                                                                            ...
                                                                            <div class="col-xl-12 text-center mt-3">
                                                                                ...
                                                                                <div class="col-xl-12 text-center mt-3">
                                                                                    ...
                                                                                    <a href="{{url('/reportreason')}}" class="btn_1" role="button">back</a>
                                                                                </div>
