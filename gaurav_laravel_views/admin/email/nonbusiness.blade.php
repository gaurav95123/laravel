                        ...
                        <tbody>
                            ...
                            <tr>
                                <td style="padding: 0px 45px;color: #000;font-size: 14px;font-weight: 400;">
                                    <p style="text-align: left; margin-top: 0;">Hi {{ $non_busines_name }},</p>
                                    
                                    <P style="margin-top: 0; margin-bottom: 0;">We have received your request for creating an Lovesecret account.Your Account Details are as below:</P>
                                   <P style="border: 1px solid #e0e0e0;padding: 25PX;border-radius: 5px;margin: 0px;margin: 30px 0px;"><span style="display: block;margin-bottom: 7px;"><b style="margin-right: 10px;"> Username:</b> {{ $email }}</span> <span style="display: block;"><b style="margin-right: 10px;"> Password:</b> {{ $password }}</span></P>
