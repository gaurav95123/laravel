            ...
            <div class="col-12">
                <div class="page_title_box d-flex flex-wrap align-items-center justify-content-between">
                    <div class="page_title_left">
                        <h3 class="f_s_25 f_w_700 dark_text">List of posts</h3>
                    ...
                    <div class="page_title_right">
                        <div class="add_button ms-2">
                            <!-- < href="{{url('/add_businesscategory')}}" class="btn_1">Add Business Category</
                             <a href="{{url('/businesscategory/exportcsv')}}" class="btn_1">Download CSV</a> -->

                            <a href="{{url('/listofpost/exportcsv')}}" class="btn_1">Download CSV</a>
                            <a href="{{url('/listofpost/exportexcel')}}" class="btn_1">Downloadexcel</a>
                        </div>
                    </div>
                </div>
            </div>
